...
export class TrainingController {
  ...
  async create(
    ...
    const newTraining = await this.trainingService.create(dto, req.user.email);
  ...
  async update(
    ...
    const updatedTraining = await this.trainingService.update(trainingId, dto, req.user.email);
  ...
  async showTrainings(
    ...
    const existsTrainings = await this.trainingService.getSomeTrainings(req.user.email, dto, query.count);
