...
describe('ShopUserController', () => {
  ...
  describe('GetFriends', () => {
    it('should return user`s friends array', async () => {
      ...
      expect(await shopUserController.showFriends(userStub().id, requestMock)).toEqual(user);
    });
  });
  ...
  describe('UpdateFriendsList', () => {
    it('should return user with updated friends array', async () => {
      ...
      expect(await shopUserController.updateFriends(userStub().id, requestMock, requestMock)).toEqual(user);
    });
  });
  ...
  describe('UpdateUserBalance', () => {
    it('should update user balance', async () => {
      let user: User;
      let updateUserBalance: UpdateUserBalanceDto = {
